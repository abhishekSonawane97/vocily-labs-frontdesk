...
4. Confirm the preview shows **15 clean pages**, nothing cut across a break. Save.
...
|---|---|---|---|
| **7 · Patient Journey** | `mujhe thyroid test karwana hai` → then your name | "What's your name?" → "✅ Booked! Token #N …" | the booking chat |
| **9 · Report Delivery** | *(in the staff group)* post `8983340017` | patient gets "📄 your report is ready"; group shows "✅ Marked … Ready" | the report chat |
| **3 · Magic Moment** | after 11 PM IST: `Need a thyroid test tomorrow morning` | "…request is saved … we're closed (open 7 AM) … 🌙" | the after-hours chat |
...
| **3 · Magic Moment** | `<section class="page hero" style="--hero:url('assets/night.jpg')">` | a dim lab at night / closed shutter |
| **15 · Final** | `<section class="page hero center final" style="--hero:url('assets/final.jpg')">` | a calm open lab at sunrise |
...
- The demo sends a **"report ready" text** — do **not** stage a fake PDF-in-chat. The deck already
  states the PDF-in-chat is the *production* capability (page 9).
